...
mock.module('@lbtcode/builtin-tools/tools/BashTool/toolName.js', () => ({
  BASH_TOOL_NAME: TOOL_NAMES.Bash,
}))
mock.module('@lbtcode/builtin-tools/tools/FileReadTool/prompt.js', () => ({
  FILE_READ_TOOL_NAME: TOOL_NAMES.Read,
}))
mock.module('@lbtcode/builtin-tools/tools/FileEditTool/constants.js', () => ({
  FILE_EDIT_TOOL_NAME: TOOL_NAMES.Edit,
}))
mock.module('@lbtcode/builtin-tools/tools/FileWriteTool/prompt.js', () => ({
  FILE_WRITE_TOOL_NAME: TOOL_NAMES.Write,
}))
mock.module('@lbtcode/builtin-tools/tools/GlobTool/prompt.js', () => ({
  GLOB_TOOL_NAME: TOOL_NAMES.Glob,
}))
mock.module('@lbtcode/builtin-tools/tools/GrepTool/prompt.js', () => ({
  GREP_TOOL_NAME: TOOL_NAMES.Grep,
}))
mock.module('@lbtcode/builtin-tools/tools/AgentTool/constants.js', () => ({
  AGENT_TOOL_NAME: TOOL_NAMES.Agent,
  VERIFICATION_AGENT_TYPE: 'verification',
}))
mock.module('@lbtcode/builtin-tools/tools/AgentTool/forkSubagent.js', () => ({
  isForkSubagentEnabled: () => false,
}))
mock.module('@lbtcode/builtin-tools/tools/AgentTool/builtInAgents.js', () => ({
  areExplorePlanAgentsEnabled: () => false,
}))
mock.module(
  '@lbtcode/builtin-tools/tools/AgentTool/built-in/exploreAgent.js',
  () => ({
...
mock.module(
  '@lbtcode/builtin-tools/tools/AskUserQuestionTool/prompt.js',
  () => ({ ASK_USER_QUESTION_TOOL_NAME: TOOL_NAMES.AskUserQuestion })
)
mock.module('@lbtcode/builtin-tools/tools/TodoWriteTool/constants.js', () => ({
  TODO_WRITE_TOOL_NAME: 'TodoWrite',
}))
mock.module('@lbtcode/builtin-tools/tools/TaskCreateTool/constants.js', () => ({
...
mock.module('@lbtcode/builtin-tools/tools/SkillTool/constants.js', () => ({
  SKILL_TOOL_NAME: TOOL_NAMES.Skill,
}))
mock.module('@lbtcode/builtin-tools/tools/SleepTool/prompt.js', () => ({
  SLEEP_TOOL_NAME: TOOL_NAMES.Sleep,
}))
mock.module('@lbtcode/builtin-tools/tools/REPLTool/constants.js', () => ({
...
describe('Opus 4.7 Prompt Engineering Audit', () => {
  ...
  describe('#13 Product information', () => {
    test('env info contains LBTCode product description', async () => {
      const envInfo = await computeSimpleEnvInfo('claude-opus-4-7')
      expect(envInfo).toContain('LBTCode')

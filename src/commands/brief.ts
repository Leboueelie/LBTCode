...
import { isBriefEntitled } from '@lbtcode/builtin-tools/tools/BriefTool/BriefTool.js'
import { BRIEF_TOOL_NAME } from '@lbtcode/builtin-tools/tools/BriefTool/prompt.js'

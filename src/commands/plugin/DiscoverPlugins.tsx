...
import { type InstallablePlugin, buildPluginDetailsMenuOptions, extractGitHubRepo } from './pluginDetailsHelpers.js';
    ...
    case 'git-not-installed':
      return (
        <>
          ...
          <Text dimColor>Please install git and restart LBTCode.</Text>
        </>
      );

...
describe('Cost command subscriber messages', () => {
  test('overage message mentions the key behavior', () => {
    const msg =
      'You are currently using your overages to power your LBTCode usage. We will automatically switch you back to your subscription rate limits when they reset'
  ...
  test('subscription message is concise', () => {
    const msg =
      'You are currently using your subscription to power your LBTCode usage'

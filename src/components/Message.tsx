  ...
  switch (message.type) {
    ...
    case 'system':
      ...
      if (feature('HISTORY_SNIP')) {
        ...
        const { isSnipBoundaryMessage } = require('../services/compact/snipProjection.js') as typeof import(
          '../services/compact/snipProjection.js'
        );
        const { isSnipMarkerMessage } = require('../services/compact/snipCompact.js') as typeof import(
          '../services/compact/snipCompact.js'
        );
        /* eslint-enable @typescript-eslint/no-require-imports */
        if (isSnipBoundaryMessage(message)) {
          /* eslint-disable @typescript-eslint/no-require-imports */
          const { SnipBoundaryMessage } = require('./messages/SnipBoundaryMessage.js') as typeof import(

    ...
    return (
      <Box flexDirection="column" padding={1}>
        <Box flexDirection="row">
          <Spinner />
          <Text bold>Loading LBTCode sessions…</Text>
        </Box>
        <Text dimColor>{retrying ? 'Retrying…' : 'Fetching your LBTCode sessions…'}</Text>
      </Box>
    );
  }
    ...
    return (
      <Box flexDirection="column" padding={1}>
        <Text bold color="error">
          Error loading LBTCode sessions
        </Text>
    ...
    case 'other':
      return (
        <Box marginY={1} flexDirection="row">
          <Text dimColor>Sorry, LBTCode encountered an error</Text>
        </Box>
      );
  }
}

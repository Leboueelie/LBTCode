...
import type { AgentDefinitionsResult } from '@lbtcode/builtin-tools/tools/AgentTool/loadAgentsDir.js';
...
const SEND_USER_FILE_TOOL_NAME: string | null = feature('KAIROS')
  ? (
      require('@lbtcode/builtin-tools/tools/SendUserFileTool/prompt.js') as typeof import(
        '@lbtcode/builtin-tools/tools/SendUserFileTool/prompt.js'
      )

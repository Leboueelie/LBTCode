...
import { PowerShellTool } from '@lbtcode/builtin-tools/tools/PowerShellTool/PowerShellTool.js';
...
const ReviewArtifactTool = feature('REVIEW_ARTIFACT')
  ? (
      require('@lbtcode/builtin-tools/tools/ReviewArtifactTool/ReviewArtifactTool.js') as typeof import(
        '@lbtcode/builtin-tools/tools/ReviewArtifactTool/ReviewArtifactTool.js'
      )
    ).ReviewArtifactTool
  : null;
...
const WorkflowPermissionRequest = feature('WORKFLOW_SCRIPTS')
  ? (
      require('../../workflow/WorkflowPermissionRequest.js') as typeof import(
        '../../workflow/WorkflowPermissionRequest.js'
      )
...
const MonitorTool = feature('MONITOR_TOOL')
  ? (
      require('@lbtcode/builtin-tools/tools/MonitorTool/MonitorTool.js') as typeof import(
        '@lbtcode/builtin-tools/tools/MonitorTool/MonitorTool.js'
      )
    ).MonitorTool
  : null;
...
function getNotificationMessage(toolUseConfirm: ToolUseConfirm): string {
  ...
  if (toolUseConfirm.tool === ExitPlanModeV2Tool) {
    return 'LBTCode needs your approval for the plan';
  }

  if (toolUseConfirm.tool === EnterPlanModeTool) {
    return 'LBTCode wants to enter plan mode';
  }
  ...
  if (!toolName || toolName.trim() === '') {
    return 'LBTCode needs your attention';
  }

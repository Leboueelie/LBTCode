...
export function BypassPermissionsModeDialog({ onAccept }: Props): React.ReactNode {
  ...
  return (
    <Dialog title="WARNING: LBTCode running in Bypass Permissions mode" color="error" onCancel={handleEscape}>
      <Box flexDirection="column" gap={1}>
        <Text>
          In Bypass Permissions mode, LBTCode will not ask for your approval before running potentially dangerous
          commands.
          <Newline />

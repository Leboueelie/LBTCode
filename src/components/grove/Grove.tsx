...
function GracePeriodContentBody(): React.ReactNode {
  return (
    <>
      ...
      <Text>
        Learn more (<Link url={'https://www.anthropic.com/news/updates-to-our-consumer-terms'} />) or read the updated
        Consumer Terms (<Link url={'https://anthropic.com/legal/terms'} />) and Privacy Policy (

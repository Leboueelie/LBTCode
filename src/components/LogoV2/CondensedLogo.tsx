...
export function CondensedLogo(): ReactNode {
  ...
  // Truncate version to fit within available width, accounting for "LBTCode v" prefix
  const versionPrefix = 'LBTCode v';
    ...
    <OffscreenFreeze>
      <Box flexDirection="row" gap={2} alignItems="center">
        ...
        <Box flexDirection="column">
          <Text>
            <Text bold>LBTCode</Text> <Text dimColor>v{truncatedVersion}</Text>
          </Text>
          {shouldSplit ? (
            <>

...
import { OUTPUT_STYLE_CONFIG, type OutputStyleConfig, getAllOutputStyles } from '../constants/outputStyles.js';
  ...
  return (
    ...
    >
      <Box flexDirection="column" gap={1}>
        <Box marginTop={1}>
          <Text dimColor>This changes how LBTCode communicates with you</Text>
        </Box>
        {isLoading ? (

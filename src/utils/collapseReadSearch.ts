...
import { extractBashCommentLabel } from '@lbtcode/builtin-tools/tools/BashTool/commentLabel.js'
...
import { REPL_TOOL_NAME } from '@lbtcode/builtin-tools/tools/REPLTool/constants.js'
import { getReplPrimitiveTools } from '@lbtcode/builtin-tools/tools/REPLTool/primitiveTools.js'
...
import {
  ...
  type PrAction,
  detectGitOperation,
} from '@lbtcode/builtin-tools/tools/shared/gitOperationTracking.js'
...
const SNIP_TOOL_NAME = feature('HISTORY_SNIP')
  ? (
      require('@lbtcode/builtin-tools/tools/SnipTool/prompt.js') as typeof import(
        '@lbtcode/builtin-tools/tools/SnipTool/prompt.js'
      )
    ).SNIP_TOOL_NAME
  : null

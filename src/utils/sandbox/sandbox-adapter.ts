...
/**
 * Resolve LBTCode-specific path patterns for sandbox-runtime.
 *
 * LBTCode uses special path prefixes in permission rules:
...
/**
 * Convert LBTCode settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where LBTCode started)

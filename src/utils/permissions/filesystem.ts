...
import { isAgentMemoryPath } from '@lbtcode/builtin-tools/tools/AgentTool/agentMemory.js'
import {
  CLAUDE_FOLDER_PERMISSION_PATTERN,
  FILE_EDIT_TOOL_NAME,
  GLOBAL_CLAUDE_FOLDER_PERMISSION_PATTERN,
} from '@lbtcode/builtin-tools/tools/FileEditTool/constants.js'
...
// Always ask when LBTCode tries to edit its own config files
 ...
 * This is a per-user temporary directory used by LBTCode for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by LBTCode)

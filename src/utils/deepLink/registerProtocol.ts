...
const APP_NAME = 'LBTCode URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'LBTCode URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>LBTCode Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for LBTCode

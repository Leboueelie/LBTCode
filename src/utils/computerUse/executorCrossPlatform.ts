...
function getBoundHwndStr(): string | null {
  ...
  try {
    const { getBoundHwnd } = require('./platforms/win32.js') as typeof import(
      './platforms/win32.js'
    )
    return getBoundHwnd()
  } catch {
...
function getAccessibilityText(): string | undefined {
  ...
  try {
    ...
    const { captureAccessibilitySnapshot } =
      require('./win32/accessibilitySnapshot.js') as typeof import(
        './win32/accessibilitySnapshot.js'
      )
  ...
  return {
    ...
    async mouseDown(): Promise<void> {
      if (isBound() && process.platform === 'win32') {
        const { getBoundHwnd } =
          require('./platforms/win32.js') as typeof import(
            './platforms/win32.js'
          )
        const hwnd = getBoundHwnd()
        if (hwnd) {
          const { sendMouseDown } =
            require('./win32/windowMessage.js') as typeof import(
              './win32/windowMessage.js'
            )
...
$i = New-Object MUp+INPUT; $i.type=0; $i.mi.dwFlags=0x0004; [MUp]::SendInput(1, @($i), [Runtime.InteropServices.Marshal]::SizeOf($i)) | Out-Null`,
    ...
    async openTerminal(opts: {
      ...
      try {
        const { listWindows: enumWindows } =
          require('./win32/windowEnum.js') as typeof import(
            './win32/windowEnum.js'
          )
        const { bindWindow } = require('./platforms/win32.js') as typeof import(
          './platforms/win32.js'
        )
    ...
    async unbindFromWindow() {
      ...
      const { unbindWindow } = require('./platforms/win32.js') as typeof import(
        './platforms/win32.js'
      )
      unbindWindow()
      _ncOffset = null
    ...
    async statusIndicator(
      ...
      try {
        const ind = require('./win32/inputIndicator.js') as typeof import(
          './win32/inputIndicator.js'
        )
    ...
    async virtualKeyboard(opts: {
      ...
      try {
        ...
        const wm = require('./win32/windowMessage.js') as typeof import(
          './win32/windowMessage.js'
        )
        const { VK_MAP } = require('./win32/shared.js') as typeof import(
          './win32/shared.js'
        )
    ...
    async virtualMouse(opts: {
      ...
      try {
        ...
        const vc = require('./win32/virtualCursor.js') as typeof import(
          './win32/virtualCursor.js'
        )
    ...
    async mouseWheel(
      ...
      try {
        ...
        try {
          const bridge = require('./win32/bridgeClient.js') as typeof import(
            './win32/bridgeClient.js'
          )
    ...
    async clickElement(query: {
      ...
      try {
        ...
        const { clickElement: uiaClick } =
          require('./win32/uiAutomation.js') as typeof import(
            './win32/uiAutomation.js'
          )

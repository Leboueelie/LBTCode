...
import { MODIFIER_KEYS, VK_MAP, runPs, validateHwnd } from './shared.js'
 ...
 * This is required for terminal apps like LBTCode REPL that read stdin in raw mode.
 */
export function consoleKey(hwnd: string, vk: number, ch = '\0'): boolean {
  hwnd = validateHwnd(hwnd)

...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when LBTCode was first started on this machine
  ...
  // LBTCode usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first LBTCode OAuth token
  ...
  // LBTCode hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).

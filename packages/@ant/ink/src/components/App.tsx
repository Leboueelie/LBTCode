...
import { type SelectionState, finishSelection, hasSelection, startSelection } from '../core/selection.js';
...
export default class App extends PureComponent<Props, State> {
  ...
  handleSuspend = (): void => {
    ...
    // Emit suspend event for LBTCode to handle. Mostly just has a notification
    ...
    const resumeHandler = () => {
      ...
      // Emit resume event for LBTCode to handle

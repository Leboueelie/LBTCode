      ...
      if (feature('UDS_INBOX') && typeof input.message === 'string') {
        ...
        if (addr.scheme === 'bridge') {
          ...
          const { postInterClaudeMessage } =
            require('src/bridge/peerSessions.js') as typeof import(
        ...
        if (addr.scheme === 'uds') {
          ...
          const { sendToUdsSocket } =
            require('src/utils/udsClient.js') as typeof import(
        ...
        if (addr.scheme === 'tcp' && feature('LAN_PIPES')) {
          const { parseTcpTarget } =
            require('src/utils/peerAddress.js') as typeof import(
              'src/utils/peerAddress.js'
            )
          const { PipeClient } =
            require('src/utils/pipeTransport.js') as typeof import(
              'src/utils/pipeTransport.js'
            )

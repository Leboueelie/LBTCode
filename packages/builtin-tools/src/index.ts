// builtin-tools — All tool implementations for LBTCode
...
// WorkflowTool 实现已迁移到 @lbtcode/workflow-engine（独立包，端口适配）。
// 注意：本 commit 移除了 builtin-tools 的 WorkflowTool 值导出和 getWorkflowCommands。
// - WorkflowTool 工厂：改由 @lbtcode/workflow-engine 的 createWorkflowTool 提供

...
- 修复建议: 当 LBTCode 知道工具开始执行时,发出一个中间的 tool_call_update:
...
| §5.8 rawInput 浅克隆 | Schema-valid,仅在嵌套对象被后续突变时才有问题；LBTCode 工具 input 通常不可变。低风险。 |

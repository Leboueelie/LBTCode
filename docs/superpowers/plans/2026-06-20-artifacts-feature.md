 ...
 */
export const ARTIFACTS_DEFAULT_TOKEN = 'lbtcode'
export const ARTIFACTS_DEFAULT_URL = 'https://cloud-artifacts.lbtcode.win'
...
describe('uploadArtifact', () => {
  ...
  test('returns id/url/expiresAt on successful upload', async () => {
    globalThis.fetch = mockFetch({
      ...
      url: 'https://cloud-artifacts.lbtcode.win/7d/V1StGXR8_Z5jdHi6B.html',
...
```bash
bun -e "import('@lbtcode/builtin-tools').then(m => console.log(typeof m.ArtifactTool))"
```
...
```typescript
const ArtifactTool = require('@lbtcode/builtin-tools/tools/ArtifactTool/ArtifactTool.js').ArtifactTool
```

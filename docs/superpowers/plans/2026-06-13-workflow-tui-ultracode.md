...
import type { ProgressEvent, AgentRunResult } from '@lbtcode/workflow-engine'
...
mock.module('@lbtcode/builtin-tools/tools/AgentTool/runAgent.js', () => ({
  runAgent: async function* () {
    yield { type: 'assistant', message: { content: [{ type: 'text', text: 'agent-text' }] } }
  },
}))
mock.module('@lbtcode/builtin-tools/tools/AgentTool/agentToolUtils.js', () => ({
  finalizeAgentTool: () => ({
...
mock.module('@lbtcode/builtin-tools/tools/AgentTool/loadAgentsDir.js', () => ({
  isBuiltInAgent: () => true,
}))
...
import { finalizeAgentTool } from '@lbtcode/builtin-tools/tools/AgentTool/agentToolUtils.js'
...
```ts
import { type AgentAdapterRegistry } from '@lbtcode/workflow-engine'
import { claudeCodeBackend } from './backends/claudeCodeBackend.js'

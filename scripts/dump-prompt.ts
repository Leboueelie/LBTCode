...
// Tool name mocks
mock.module(
  '@lbtcode/builtin-tools/tools/BashTool/toolName.js',
  () => ({ BASH_TOOL_NAME: 'Bash' }),
)
mock.module(
  '@lbtcode/builtin-tools/tools/FileReadTool/prompt.js',
  () => ({ FILE_READ_TOOL_NAME: 'Read' }),
)
mock.module(
  '@lbtcode/builtin-tools/tools/FileEditTool/constants.js',
  () => ({ FILE_EDIT_TOOL_NAME: 'Edit' }),
)
mock.module(
  '@lbtcode/builtin-tools/tools/FileWriteTool/prompt.js',
...
mock.module(
  '@lbtcode/builtin-tools/tools/AgentTool/constants.js',
  () => ({ AGENT_TOOL_NAME: 'Agent', VERIFICATION_AGENT_TYPE: 'verification' }),
)
mock.module(
  '@lbtcode/builtin-tools/tools/AgentTool/forkSubagent.js',
  () => ({ isForkSubagentEnabled: () => false }),
)
mock.module(
  '@lbtcode/builtin-tools/tools/AgentTool/builtInAgents.js',
...
mock.module(
  '@lbtcode/builtin-tools/tools/TodoWriteTool/constants.js',
  () => ({ TODO_WRITE_TOOL_NAME: 'TodoWrite' }),
)
mock.module(
  '@lbtcode/builtin-tools/tools/TaskCreateTool/constants.js',
...
mock.module(
  '@lbtcode/builtin-tools/tools/SkillTool/constants.js',
  () => ({ SKILL_TOOL_NAME: 'Skill' }),
)
mock.module(
  '@lbtcode/builtin-tools/tools/SleepTool/prompt.js',
  () => ({ SLEEP_TOOL_NAME: 'Sleep' }),
)
mock.module(
  '@lbtcode/builtin-tools/tools/REPLTool/constants.js',

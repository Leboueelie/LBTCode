...
- [ ] 我已经搜索过 [现有 Issues](https://github.com/lbtcode/claude-code/issues)，没有找到重复。
- [ ] 我使用的是 **最新版本**（`bun run build` 或最新 release）。
- [ ] 我已经阅读过 [README](https://github.com/lbtcode/claude-code) 和相关文档。
...
| LBTCode 版本| 例如 `2.4.3` 或 commit hash|
